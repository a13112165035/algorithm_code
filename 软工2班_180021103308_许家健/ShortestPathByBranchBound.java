...
public class ShortestPathByBranchBound {
	...
	public static void main(String[] args) {
		...
		System.out.println("请输入图的路径长度，不可达用-1表示：");
		...
		int v = 1;// 顶点从1开始
		ShortestPath(a, v, dist, prev);// a[][]存放结点间路径长度
		sc.close();
	}
	...
	public static void ShortestPath(float[][] a, int v, float[] dist, int[] p) {
		// dist[j]保存从源到顶点j的距离;
